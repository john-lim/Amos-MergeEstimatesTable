...
Public Class CustomCode
    ...
    Sub CreateOutput()
        ...
        If (System.IO.File.Exists("CleanEstimatesTable.html")) Then 'Check if the output file already exists.
            System.IO.File.Delete("CleanEstimatesTable.html")
        End If

        'Set up the listener to output the debugger.
        Dim debug As New AmosDebug.AmosDebug
        Dim resultWriter As New TextWriterTraceListener("CleanEstimatesTable.html")
        Trace.Listeners.Add(resultWriter)

        'HTML DOC
        debug.PrintX("<html><body><h1>Merged Regression Weights</h1><hr/>")
        ...
        'References
        debug.PrintX("</table><h3>References</h3>Significance of Correlations:<br>*** p < 0.001<br>** p < 0.010<br>* p < 0.050<br>&#x271D; p < 0.100<br>")
        ...
        Process.Start("CleanEstimatesTable.html")
    End Sub
